          ...
          requestAnimationFrame: function () {
            a.debug("Normalizing requestAnimationFrame"),
              t.requestAnimationFrame === i &&
                (a.debug(
                  "RequestAnimationFrame not available, normailizing event"
                ),
          ...
          (F = {
            ...
            event: {
              field: {
                ...
                blur: function () {
                  ...
                  n.hasClass(S.error)
                    ? (F.debug("Revalidating field", t, i), F.validate.field(i))
                ...
                change: function () {
                  var t = e(this),
                    n = t.closest(g);
                  ("change" == x.on || (n.hasClass(S.error) && x.revalidate)) &&
                    (clearTimeout(F.timer),
                    (F.timer = setTimeout(function () {
                      F.debug("Revalidating field", t, F.get.validation(t)),
                        F.validate.field(F.get.validation(t));
                    }, x.delay)));
                },
              },
            },
            ...
            validate: {
              ...
              field: function (t) {
                ...
                return (
                  n.prop("disabled")
                    ? (F.debug("Field is disabled. Skipping", t.identifier),
                      (o = !0))
                    : t.optional && "" === e.trim(n.val())
                    ? (F.debug(
                    ...
                    : t.rules !== i &&
                      e.each(t.rules, function (e, n) {
                        F.has.field(t.identifier) &&
                          !F.validate.rule(t, n) &&
                          (F.debug("Field is invalid", t.identifier, n.type),
                          a.push(n.prompt),
                          (o = !1));
                      }),
                  o
                    ? (F.remove.prompt(t, a), x.onValid.call(n), !0)
                    : ((q = q.concat(a)),
                      F.add.prompt(t.identifier, a),
                      x.onInvalid.call(n, a),
                      !1)
                );
              },
              rule: function (t, n) {
                ...
                if (
                  ...
                  if (
                    ...
                    return void F.error(T.noRule, r);
                  d = o.call(s, l, a);
                } else {
                  if (((o = x.rules[c]), !e.isFunction(o)))
                    return void F.error(T.noRule, c);
                  d = o.call(s, l);
                }
                return d;
              },
                  ...
                  f.animateChildren &&
                    (e.fn.transition !== i && C.transition("is supported")
                      ...
                      : o
                          .children()
                          .stop(!0, !0)
                          .animate({ opacity: 1 }, f.duration, m.resetOpacity)),
                ...
                f.animateChildren &&
                  (e.fn.transition !== i && C.transition("is supported")
                    ...
                    : o
                        .children()
                        .stop(!0, !0)
                        .animate({ opacity: 0 }, f.duration, m.resetOpacity)),
            ...
            event: {
              click: function (t) {
                ...
                return n.is(v.input)
                  ...
                  : (m.toggle(), w.focus(), void t.preventDefault());
              },
              keydown: function (e) {
                var t = e.which,
              ...
              allowCheck: function () {
                return m.is.determinate() &&
                  ...
                  ? (m.debug(
                    ...
                    !1)
                  : f.beforeChecked.apply(k) === !1
                  ? (m.debug("Should not allow check, beforeChecked cancelled"),
                    !1)
                  : !0;
              },
              ...
              allowIndeterminate: function () {
                return m.is.indeterminate() && !m.should.forceCallbacks()
                  ? (m.debug(
                    ...
                    !1)
                  : f.beforeIndeterminate.apply(k) === !1
                  ? (m.debug(
            ...
            bind: {
              events: function () {
                m.verbose("Attaching checkbox events"),
                  x
                    .on("click" + b, m.event.click)
                    .on("keydown" + b, v.input, m.event.keydown)
                    .on("keyup" + b, v.input, m.event.keyup);
              },
            },
            unbind: {
              events: function () {
          ...
          (w = {
            ...
            observeChanges: function () {
              "MutationObserver" in t &&
                ...
                w.has.input() &&
                  x.observe(H[0], { childList: !0, subtree: !0 }),
            ...
            setup: {
              ...
              layout: function () {
                z.is("select") && (w.setup.select(), w.setup.returnedObject()),
                ...
                w.debug("Dropdown initialized on a select", t),
                  ...
                  H.parent(F.dropdown).length > 0
                    ...
                    : (w.debug("Creating entire dropdown from select"),
                      ...
                      H.removeAttr("class").detach().prependTo(z)),
                  w.refresh();
              },
              menu: function (e) {
            ...
            bind: {
              ...
              touchEvents: function () {
                w.debug(
                  ...
                  w.is.searchSelection() ||
                    (w.is.single() &&
                      z.on("touchstart" + q, w.event.test.toggle)),
              ...
              keyboardEvents: function () {
                w.verbose("Binding keyboard events"),
                  ...
                  w.has.search() &&
                    z.on(w.get.inputEvent() + q, F.search, w.event.input),
                  w.is.multiple() &&
              ...
              mouseEvents: function () {
                w.verbose("Binding mouse events"),
                  w.is.multiple() &&
                    z
                      .on("click" + q, F.label, w.event.label.click)
                      .on("click" + q, F.remove, w.event.remove.click),
                  w.is.searchSelection()
                    ? (z
                        .on("mousedown" + q, F.menu, w.event.menu.mousedown)
                        .on("mouseup" + q, F.menu, w.event.menu.mouseup)
                        .on("click" + q, F.icon, w.event.icon.click)
                        .on("click" + q, F.search, w.show)
                        .on("focus" + q, F.search, w.event.search.focus)
                        .on("blur" + q, F.search, w.event.search.blur)
                        .on("click" + q, F.text, w.event.text.focus),
                      w.is.multiple() && z.on("click" + q, w.event.click))
                    : ("click" == k.on
                        ? z
                            .on("click" + q, F.icon, w.event.icon.click)
                            .on("click" + q, w.event.test.toggle)
                        : "hover" == k.on
                        ? z
                            .on("mouseenter" + q, w.delay.show)
                            .on("mouseleave" + q, w.delay.hide)
                        : z.on(k.on + q, w.toggle),
                      z
                        .on("mousedown" + q, w.event.mousedown)
                        .on("mouseup" + q, w.event.mouseup)
                        .on("focus" + q, w.event.focus)
                        .on("blur" + q, w.event.blur)),
                  U.on("mouseenter" + q, F.item, w.event.item.mouseenter)
                    .on("mouseleave" + q, F.item, w.event.item.mouseleave)
                    .on("click" + q, F.item, w.event.item.click);
              },
              intent: function () {
            ...
            event: {
              ...
              blur: function (e) {
                (h = n.activeElement === this),
                  B || h || (w.remove.activeLabel(), w.hide());
              },
              mousedown: function () {
                B = !0;
              },
                    ...
                    t == n.leftArrow
                      ? (!g && !p) || c
                        ? c &&
                          ...
                          u && !l
                            ? a.addClass(S.active)
                            : a.prev(F.siblingLabel).addClass(S.active).end(),
                          e.preventDefault())
                        : (w.verbose("Selecting previous label"),
                          o.last().addClass(S.active))
                      : t == n.rightArrow
                      ? (g && !c && o.first().addClass(S.active),
                        c &&
                          (e.shiftKey
                          ...
                          d
                            ? m
                              ? f
                                ...
                                : w.focusSearch()
                              : l
                              ? a.next(F.siblingLabel).addClass(S.active)
                              : a.addClass(S.active)
                            : a.next(F.siblingLabel).addClass(S.active),
                          e.preventDefault()))
              ...
              keydown: function (e) {
                ...
                if (i) {
                  var o,
                    ...
                    l =
                      c.length > 0
                        ? c.siblings(":not(." + S.filtered + ")").andSelf()
                        : U.children(":not(." + S.filtered + ")"),
                    u = c.children(F.menu),
                    d = c.closest(F.menu),
                    m =
                      d.hasClass(S.visible) ||
                      d.hasClass(S.animating) ||
                      d.parent(F.menu).length > 0,
                    f = u.length > 0,
                    g = c.length > 0,
                    p = c.not(F.unselectable).length > 0;
                  if (w.is.visible()) {
                    if (
                      ((t == n.enter || t == n.delimiter) &&
                        (t == n.enter && g && f && !k.allowCategorySelection
                          ? (w.verbose(
                    ...
                    t == n.delimiter && e.preventDefault(),
                      t == n.downArrow &&
            ...
            get: {
              ...
              value: function () {
                var t = H.length > 0 ? H.val() : z.data(R.value);
            ...
            set: {
              ...
              tabbable: function () {
                w.has.search()
                  ...
                  : (w.debug("Added tabindex to dropdown"),
                    z.attr("tabindex") ||
                      (z.attr("tabindex", 0), U.attr("tabindex", -1)));
              },
              initialLoad: function () {
              ...
              text: function (e) {
                "select" !== k.action &&
                  ("combo" == k.action
                    ? (w.debug("Changing combo button text", e, M),
            ...
            f
              ? (Y === i && w.initialize(), w.invoke(m))
              : (Y !== i && Y.invoke("destroy"), w.initialize());
        }),
        a !== i ? a : r
      );
    }),
            ...
            set: {
              ...
              position: function () {
                S.verbose("Centering modal on page", S.cache),
                  O.css(
                    S.can.fit()
                      ? { top: "", marginTop: -(S.cache.height / 2) }
        ...
        r.each(function () {
          ...
          (y = {
            ...
            get: {
              ...
              variation: function () {
                return (
                  P.removeData(S.variation), P.data(S.variation) || x.variation
                );
              },
            ...
            unbind: {
              close: function () {
                (x.hideOnScroll === !0 ||
                  ("auto" == x.hideOnScroll && "click" != x.on)) &&
                  (s.off("scroll" + h, y.hide), E.off("scroll" + h, y.hide)),
              ...
              response: function (e, t) {
                ...
                f.verbose("Parsing server response", e),
                  e !== i &&
                    ...
                    f.write.cache(t, { html: n, results: e[b.results] }),
        ...
        templates: {
          ...
          category: function (t, n) {
            ...
            return t[n.categoryResults] !== i
              ? (e.each(t[n.categoryResults], function (a, r) {
                  r[n.results] !== i &&
                    r.results.length > 0 &&
                    ((o += '<div class="category">'),
                    r[n.categoryName] !== i &&
                      (o +=
                        '<div class="name">' + r[n.categoryName] + "</div>"),
                    e.each(r.results, function (e, a) {
                      (o += t[n.url]
                        ...
                        (o += '<div class="content">'),
                        a[n.price] !== i &&
                          (o += '<div class="price">' + a[n.price] + "</div>"),
                        a[n.title] !== i &&
                          (o += '<div class="title">' + a[n.title] + "</div>"),
                        a[n.description] !== i &&
                          (o +=
                            '<div class="description">' +
                            a[n.description] +
          ...
          standard: function (t, n) {
            ...
            return t[n.results] !== i
              ? (e.each(t[n.results], function (e, a) {
                  (o += t[n.url]
                    ? '<a class="result" href="' + t[n.url] + '">'
                    : '<a class="result">'),
                    a[n.image] !== i &&
          ...
          (v = {
                        ...
                        f || v.is.mocked()
                          ? ((a = e.extend(!0, {}, h, {
                            ...
                            "local" === h.cache && v.read.cachedResponse(f)
                              ? (v.debug("Response returned from local cache"),
                                (v.request = v.create.request()),
                                void v.request.resolveWith(E, [
            ...
            should: {
              removeError: function () {
                return (
                  h.hideError === !0 || ("auto" === h.hideError && !v.is.form())
                );
              },
            },
            is: {
            ...
            create: {
              ...
              mockedXHR: function () {
                ...
                return (
                  ...
                  h.mockResponse
                    ? (e.isFunction(h.mockResponse)
                        ? (v.debug(
                            "Using mocked callback returning response",
                            h.mockResponse
                          ),
                          (n = h.mockResponse.call(E, h)))
                        : (v.debug("Using specified response", h.mockResponse),
                          (n = h.mockResponse)),
                      i.resolveWith(E, [n, o, { responseText: n }]))
                    : e.isFunction(h.mockResponseAsync) &&
                      ((t = function (e) {
            ...
            get: {
              ...
              settings: function () {
                var e;
                return (
                  (e = h.beforeSend.call(E, h)),
                  e &&
                    (e.success !== i &&
                      (v.debug("Legacy success callback detected", e),
                      v.error(C.legacyParameters, e.success),
                      (e.onSuccess = e.success)),
                    e.failure !== i &&
                      (v.debug("Legacy failure callback detected", e),
                      v.error(C.legacyParameters, e.failure),
                      (e.onFailure = e.failure)),
                    e.complete !== i &&
                      (v.debug("Legacy complete callback detected", e),
              ...
              urlEncodedValue: function (e) {
                ...
                return o
                  ? (v.debug(
                    ...
                    e)
                  : (v.verbose("Encoding value using encodeURIComponent", e, i),
                    i);
              },
              ...
              event: function () {
                return e.isWindow(P) || "now" == h.on
                  ? (v.debug("API called without element, no events attached"),
                    !1)
                  : "auto" == h.on
                  ? T.is("input")
                    ? P.oninput !== i
